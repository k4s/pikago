...
//pubsub.exe server tcp://127.0.0.1:40899 server
//pubsub.exe client tcp://127.0.0.1:40899 client0
//pubsub.exe client tcp://127.0.0.1:40899 client1
package main
...
import (
	...
	"github.com/k4s/pikago/protocol/pub"
	"github.com/k4s/pikago/protocol/sub"
...
func client(url string, name string) {
	...
	err = sock.SetOption(pikago.OptionSubscribe, []byte(""))
	if err != nil {
